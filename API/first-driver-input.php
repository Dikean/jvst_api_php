...
{//Este endpoint es solo de tipo post
    ...
    { //se validan que los parámetros no vayan vacíos
        ...
        else
        {
            ...
            $sql = "insert into driver(email,password,status)values(?,?,?)"; //se escribe la consulta para la sentencia preparada
    ...
    else
    {
        ...
        $response = array('code' => '1','message' => 'Unprocessable Entity, El campo token y el campo email no pueden ir vacíos.');
