...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    // Obtener todos los datos de la tabla documents con el nombre del usuario
    $sql = "SELECT d.*, u.name AS user_name
            FROM documents d
            JOIN users u ON d.users_id = u.id"; // Realizar un JOIN para obtener el nombre del usuario
