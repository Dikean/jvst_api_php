...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    // Obtener todos los datos de la tabla healthy_conditions con el nombre del usuario
    $sql = "SELECT hc.*, u.name AS user_name
            FROM healthy_conditions hc
            JOIN users u ON hc.users_id = u.id"; // Realizar un JOIN para obtener el nombre del usuario
