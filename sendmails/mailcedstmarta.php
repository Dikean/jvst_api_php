...
function send($recipiente,$factura){
        ...
        try {
            ...
            $mail->Username   = 'facele2@estrateg.com';                     //SMTP username
         
            $mail->Password   = 'aLv5wpkUyBTzNJKh';                               //SMTP password
           ...
           //Destinatario
            ...
            $mail->Subject = '900361147;CLINICA DE ENFERMEDADES DIGESTIVAS S.A.S.;CED'.$factura.';01;CLINICA DE ENFERMEDADES DIGESTIVAS S.A.S';
