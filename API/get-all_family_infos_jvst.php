...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    // Obtener todos los datos de la tabla family_infos con el nombre del usuario
    $sql = "SELECT fi.*, u.name AS user_name
            FROM family_infos fi
            JOIN users u ON fi.users_id = u.id"; // Realizar un JOIN para obtener el nombre del usuario
