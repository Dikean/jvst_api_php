...
{//Este endpoint es solo de tipo post
    ...
    { //se validan que los parámetros no vayan vacíos
        ...
        else
        {
            ...
            $availability = explode(',', $_POST['availability_id']);

            foreach ($availability as  $value)
            {
                $sql = "insert into avaliability_driver(avaliability_id, driver_id)values(?, ?)"; //se escribe la consulta para la sentencia preparada
