...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['name'])) {
        ...
        // Construye la consulta SQL para filtrar los datos por 'name' en la tabla 'users'
        $sql = "SELECT *
                FROM users
                WHERE name = ?"; // Filtrar por el nombre de usuario
        ...
        if (empty($data)) {
            ...
            $response = array('code' => '1', 'message' => 'No se encontraron usuarios para el nombre proporcionado.');
        } else {
