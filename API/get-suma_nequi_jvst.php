...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    // Define la consulta SQL para obtener la suma de los "amount" cuando el "bank" es "nequi"
    $sql = "SELECT IFNULL(SUM(amount), 0) AS total_amount FROM consignments WHERE bank = 'nequi'";
